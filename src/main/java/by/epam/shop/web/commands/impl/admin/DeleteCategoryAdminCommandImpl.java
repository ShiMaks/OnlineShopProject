...
public class DeleteCategoryAdminCommandImpl implements BaseCommand {
    ...
    private static final String MESSAGE_ERROR_VALUE = "error_delete_category";
    ...
    public String executeCommand(HttpServletRequest request) throws CommandException {
        ...
        try {
            ...
            request.getSession().setAttribute(SESSION_PAGE_TYPE, PAGE_TYPE_ADMIN_CATEGORY);
            request.getSession().setAttribute(REQUEST_PARAM_SESSION_MESSAGE, MESSAGE_ERROR_VALUE);
            return REDIRECT_ADMIN_URL;
        }
    }
}
