...
<head>
  <meta charset="utf-8">
  <title>My Account: Order Details</title>
          ...
          <div class="col-md-9 col-sm-8">
            ...
            <div class="content-page">
              <div class="col-12">
                  <div class="card">
                      <div class="card-body">
                          <h4><fmt:message key="no_order" />: ${order.getId()}</h4>
                      </div>
                      <div class="table-responsive">
                          <table class="table table-hover">
                              <thead>
                                  <tr>
                                      <th class="border-top-0"><fmt:message key="picture" /></th>
                                      <th class="border-top-0"><fmt:message key="entity_name" /></th>
                                      <th class="border-top-0"><fmt:message key="description" /></th>
