      ...
      <div id="heading-breadcrumbs">
        <div class="container">
          <div class="row d-flex align-items-center flex-wrap">
            <div class="col-md-7">
              <h1 class="h2"><c:out value="${product.getName()}"/></h1>
            </div>
              ...
              <div id="productMain" class="row">
                <div class="col-sm-6">
                  <div data-slider-id="1" class="owl-carousel shop-detail-carousel">
                    <li class="active-slide"><a data-rel='prettyPhoto[product]' href="" data-image="" data-zoom-image="" class="product-gallery-item"><img src="${product.getPicture()}" alt="Phone photo 1"></a></li>
                ...
                <div class="col-sm-6">
                  <div class="box">
                    <form>
                      ...
                      <p class="text-center">
                        <a href="" class="btn btn-template-outlined" role="button"><i class="fa fa-shopping-cart"></i> Add to cart</a>
